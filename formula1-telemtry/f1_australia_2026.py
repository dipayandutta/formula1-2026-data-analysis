...
'''
#console.print(Rule("[bold red]FORMULA 1 — 2026 AUSTRALIAN GRAND PRIX[/]"))
#console.print()
print("FORMULA 1 - 2026 AUSTRALIAN GRAND PRIX")
...
'''
print(row['BroadcastName'],row.get('TeamName'))
...
for _, row in scorers.iterrows():
    ...
    #onsole.print(f"  {label}  [bold {color}]{bar}[/]")
    print(pts,team)
